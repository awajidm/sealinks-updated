...
import UserAccount from './components/Login/account';
import DomasticNational from './components/Home/domasticNational';
  ...
  <Router>
    <Layout>
      <Switch>
        ...
        <Route path='/domasticnational' component={DomasticNational} />
      </Switch>
    </Layout>
  </Router>
